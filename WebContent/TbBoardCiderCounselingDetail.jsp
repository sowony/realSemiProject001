	...
	<div id ="wrap_councelMain" style="width:1200px; margin:auto; background: gray">
		...
		<div id="mainarea_councelmain" style="margin-top: 10px;">
			...
			<div id="center_mainarea_councelmain" style="height: 600px; width: 780px; background: blue; float:left;" >
				...
				<div style="width: 370px; height: 300px; background-color:orange; float:left;  margin: 0px auto;">
				</div>
				<div style="width: 200px; height: 300px; float: right; background-color:green;">
				</div>
				
				
<!-- 				<div style="width: 200px; height: 280px; float: left; background-color:white; margin-top: 10px;"> -->
<!-- 				</div> -->
				<div style="width: 570px; height: 280px; background-color:brown; float:left;  margin: 0px auto;  margin-top: 10px;">
				</div>
				<div style="width: 200px; height: 280px; float: right; background-color:black;  margin-top: 10px;">
				</div>
